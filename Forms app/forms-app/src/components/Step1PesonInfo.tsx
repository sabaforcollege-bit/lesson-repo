...
export function Step1PersonalInfo() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col h-full justify-between">
            <div>
                <h1 className="text-3xl font-bold text-slate-800">პერსონალური ინფორმაცია</h1>
                <p className="text-slate-400 mt-2 mb-6">გთხოვთ მოგვაწოდოთ თქვენი სახელი, ემაილის მისამართი და ტელეფონის ნომერი.</p>

                <div className="space-y-4">
                    <div>
                        <div className="flex justify-between text-sm mb-1">
                            <label className="text-slate-700 font-medium">სახელი</label>
                            {errors.name && <span className="text-red-500 font-semibold">{errors.name}</span>}
                        </div>
                        <input
                            ref={nameInputRef}
                            type="text"
                            placeholder="მაგალითად giorgi bagrationi"
                    ...
                    <div>
                        <div className="flex justify-between text-sm mb-1">
                            <label className="text-slate-700 font-medium">ემაილის მისამართი</label>
                            {errors.email && <span className="text-red-500 font-semibold">{errors.email}</span>}
                        </div>
                        <input
                            ref={emailInputRef}
                            type="email"
                            placeholder="მაგალითად forexample@gmail.com"
                    ...
                    <div>
                        <div className="flex justify-between text-sm mb-1">
                            <label className="text-slate-700 font-medium">ტელეფონის ნომერი</label>
            ...
            <div className="flex justify-end mt-8">
                <button type="submit" className="cursor-pointer bg-slate-900 text-white px-6 py-3 rounded-lg hover:bg-slate-800 transition">
                    შემდეგი ნაბიჯი
                </button>
            </div>
        </form>
